...
const DEBUG = !1
  ...
  , updateRate = 30
  , frameTime = 1e3 / 30;
DEBUG && window.addEventListener("error", function(e) {
    return alert("ERROR: " + e.message + "\n" + e.filename + ":" + e.lineno + "e.colno"),
    !1
}),
window.addEventListener("load", async function() {
    const e = document.getElementById("webglcanvas")
      , t = document.getElementById("2dcanvas")
    ...
    try {
        ...
        return void alert("your browser does not support AudioContexts so yoo bad you can't play")
    }
    const o = n.destination;
    if (!(a && a instanceof WebGLRenderingContext))
        return void alert("your browser does not support webgl so too bad you can't play");
    var s = 1
      , c = 1
      , l = 0
      , m = 0
    ...
    function D() {
        var n = window.innerWidth
          , r = n / aspect;
        r > window.innerHeight && window.innerHeight / r < .87 && (n = (r = window.innerHeight) * aspect);
        var o = Math.min(n, window.innerWidth)
          , f = Math.min(r, window.innerHeight);
        E = !(window.screen.width - o < 20 && window.screen.height - f < 20),
        document.fullscreenElement && (E = !1),
        e.width = o,
        e.height = f,
        t.width = o,
        t.height = f,
            ...
            !function e(t, a, i) {
                n.decodeAudioData(t.buf, a, function(n) {
                    !function(e) {
                        ...
                        for (var a = e.sync, i = t; e.retry++,
                        !(-1 == (a = i.indexOf(255, a)) || !0 & i[a + 1]); )
                            a++;
                        if (-1 != a) {
                            var n = e.buf.slice(a);
                            return delete e.buf,
    ...
    function V(e, t) {
        ...
        a.compileShader(i),
        a.getShaderParameter(i, a.COMPILE_STATUS) ? i : (console.log("shader error: " + a.getShaderInfoLog(i)),
        a.deleteShader(i),
        null)
    }
    function z(e, t) {
        const i = a.createProgram();
        return a.attachShader(i, e),
        a.attachShader(i, t),
        a.linkProgram(i),
        a.getProgramParameter(i, a.LINK_STATUS) ? new Y(i) : (console.log("program error: " + a.getProgramInfoLog(i)),
        a.deleteProgram(i),
        null)
    }
    function Y(e) {
    ...
    var ue = .3
      , de = 1;
    function pe(e, t) {
        e == ue && t == de || (e != ue && (a.uniform1f(fe.uniforms.warp, e),
        DEBUG && console.log("setting warp: " + e)),
        t != de && (a.uniform1f(fe.uniforms.heightfac, t),
        DEBUG && console.log("setting heightfac: " + t)),
        ue = e,
        de = t)
    }
    fe.bind(),
    a.uniform1f(fe.uniforms.warp, .3),
        ...
        untar(he.response).progress(function(e) {
            ...
            function r() {
                !function e() {
                    ...
                    setTimeout(e, Math.floor(1e3 * t.duration)),
                    a.start()
                }(),
    ...
    function be(e, t, a, i) {
        return d ? f >= e - p && f <= a + p && u >= t - w && u <= i + w : f >= e && f <= a && u >= t && u <= i
    }
    function xe(e, t) {
    ...
    function zt() {
        j(J.title, K.main, !0),
        M(J.static2, .8, K.main)
    }
    function Yt() {
        var e = J.amb[xe(0, 2)];
        j(e, K.ambience),
        Me = setTimeout(Yt, Math.floor(1e3 * e.duration))
    }
    var qt = .6
      , Wt = .3
      , Jt = 69;
    ...
    function Zt() {
        Math.random() < .03 && (Ee.push(),
        Ee.scale([1280, 720]),
        a.bindTexture(a.TEXTURE_2D, W.sstatic.scan[Jt % 7]),
        C(),
        $(.5),
        Ee.pop()),
        (qt += .1 * Math.random() - .05) > .5 && (qt -= .01),
        qt > .7 && (qt = .7),
        qt < .2 && (qt = .2),
        Ee.push(),
        Ee.scale([1280, 720]),
    ...
    const sa = "fnaw1_";
    var ca, la = .5, ma = 0, fa = 0, ua = !1, da = !1, pa = !1;
    function wa(e) {
    ...
    function Ea(e) {
        var t, a, i = ia[e];
        t = 0 == i.length ? [364, 191] : ea[i[0]],
        a = ke ? ea[Se] : [366, 212];
        var n = t[0] - a[0]
          , r = t[1] - a[1]
          , o = (280 - Math.sqrt(n * n + r * r)) / 280;
        return (isNaN(o) || o < .05) && (o = .05),
        o > 1 && (o = 1),
        .5 * o
    }
    (!(ca = parseInt(window.localStorage.getItem(sa + "night"))) || ca < 1 || ca > 5 || isNaN(ca)) && (ca < 1 && (ca = 1),
    ca > 5 && (ca = 5),
    isNaN(ca) && (ca = 1),
    window.localStorage.setItem(sa + "night", ca)),
    ve = ca,
    ga(ua = "1" == window.localStorage.getItem(sa + "6th")),
    ha(da = "1" == window.localStorage.getItem(sa + "7th")),
    Ta(pa = "1" == window.localStorage.getItem(sa + "20mode")),
    setInterval(function() {
        !v && b != !E && x && (b = !E,
        E && (document.getElementById("fullscreen").style.display = "block",
        v = !0)),
        ...
        0 == ge) {
            ...
            if (we < 1) {
                var s = Math.floor(19 * we);
                P("Downloading Assets..", "Downloading Assets" + ".".repeat(o), 660),
                G("[" + "#".repeat(s) + " ".repeat(19 - s) + "]", 700)
            } else
                we < 2 ? P("Extracting..", "Extracting" + ".".repeat(o), 680) : 3 == we && G("you eagler", 700)
        } else if (1 == ge) {
            be(138, 391, 369, 441) && 0 != ma && (ma = 0,
            j(J.camswitch, K.main)),
            be(137, 458, 367, 510) && 1 != ma && (ma = 1,
            j(J.camswitch, K.main)),
            be(135, 526, 394, 586) && 2 != ma && ua && (ma = 2,
            j(J.camswitch, K.main)),
            be(129, 597, 474, 661) && 3 != ma && da && (ma = 3,
            j(J.camswitch, K.main)),
            _[38] && ma > 0 && (ma--,
            j(J.camswitch, K.main)),
            _[40] && ma < (ua ? da ? 3 : 2 : 1) && (ma++,
            j(J.camswitch, K.main)),
            Ee.push(),
            Ee.scale([1280, 720]),
            ...
            Ee.pop()),
            Ee.push(),
            1 == ma ? Ee.translate([80, 467]) : 2 == ma ? Ee.translate([80, 540]) : 3 == ma ? Ee.translate([80, 611]) : Ee.translate([80, 403]),
            Ee.scale([46, 27]),
            ...
            r = 0; r < c; r++)
                ...
                Ee.translate([1.1, 0]);
            Ee.pop(),
            $t && (T && !be(200, 50, 1080, 670) || _[27] ? $t = !1 : (i.fillStyle = "#000000",
            ...
            T ? 0 == ma && be(138, 391, 369, 441) ? (wa(1),
            Re = 1,
            L(),
            j(J.camswitch, K.main),
            fa = Te,
            ge = 2) : 1 == ma && be(137, 458, 367, 510) ? (Re = ve,
            L(),
            j(J.camswitch, K.main),
            fa = Te,
            ge = 2) : 2 == ma && be(135, 526, 394, 586) ? (Re = 6,
            L(),
            j(J.camswitch, K.main),
            fa = Te,
            ge = 2) : 3 == ma && be(129, 597, 474, 661) ? ge = 7 : be(460, 686, 704, 719) ? $t = !0 : be(1010, 0, 1280, 70) && window.open("https://g.deev.is/fnaw/explanation.html", "_blank") : y[13] && (0 == ma ? (L(),
            j(J.camswitch, K.main),
            fa = Te,
            ge = 2) : 1 == ma ? (L(),
            j(J.camswitch, K.main),
            ...
            var l = !1
              , m = !1;
            if (ke || Fe ? l = be(0, 620, 700, 720) || be(0, 710, 1280, 720) : Lt || (l = be(0, 620, 0 != It && 69 != It ? 930 : 1280, 720)),
            !ke && Te - Ie >= 10 && Fe && (ke = !0,
            m = !0,
            je = Te),
            !Le && l && 0 == Tt && !Rt && Te - Ie > 20 ? (Le = !0,
            Ie = Te,
            ke ? (j(J.camclose, K.main),
            ke = !1,
            24 == Ce ? (Tt = 1,
            Et = Te,
            S()) : 24 == Be ? (Tt = 2,
            ...
            S()) : 24 == Oe ? (Tt = 5,
            Et = Te,
            S()) : 25 == Oe && (Oe = 24)) : j(J.camopen, K.main),
            Fe = !Fe) : Le && !be(0, 620, 1280, 720) && (Le = !1),
            6 == Ge && 0 == Tt && (De || Gt ? (j(J.laxdudecrash, K.main),
            Bt || (vt -= 10 * mt),
            mt += 5,
            Ge = xe(0, 1),
            na(3),
            ...
            if (n - Dt > 6e4 && 0 == xe(0, 600)) {
                ...
                for (r = 0; r < u; r++)
                    ...
                    0 == xe(0, 1) ? d += xe(600, 1e3) : d += xe(1500, 5e3)
            }
            var p = Ce
              , w = Be
              , D = Ne
              ...
              , X = Oe;
            if (0 == Tt) {
                if (n - rt > 4959 && 0 == xe(0, 5) && (rt = n,
                xe(3, 20) < Ye || 0 != Pe && tt > 3 && 1 == xe(0, 3))) {
                    var k = 0 == Pe && tt > (1 == it ? 3 : 2) || 1 == xe(0, 2);
                    if (17 == Ce && 11 != Ne)
                        Ce = 11,
                        21 == Be && (Be = 15),
                        1 == it && 0 == It && (It = 1);
                    else if (11 == Ce || 21 == Ce)
                        (1 == (F = xe(1, 5)) || 2 == F || k) && (Ce = 3),
                        3 != F && 4 != F || 10 == Ne || (Ce = 10),
                        5 == F && (Ce = 21);
                    else if (3 == Ce) {
                        var F = xe(1, 3);
                        (n - Pe >= 6e3 * (25 - Ye) || 1 == F || 3 == F || k) && (Ce = 1),
                        2 == F && 4 != Be && (Ce = 4)
                    } else
                        1 == Ce ? ((2 == (F = xe(1, 5)) || 3 == F || 1 == it && 0 != Pe) && (Ce = 3),
                        (n - Pe >= 4e3 * (25 - Ye) || 1 == F || 4 == F || 5 == F) && (Ce = 0)) : 0 == Ce ? De || Gt ? (Pe = n,
                        Ce = 0 == xe(0, 2) ? 3 : 1) : Ce = 24 : 4 == Ce ? ((1 == (F = xe(1, 5)) || 2 == F || 5 == F || k) && (Ce = 3),
                        3 == F && 6 != Ne && (Ce = 5),
                        4 == F && 6 != Ne && (Ce = 6)) : 5 == Ce || 6 == Ce ? (1 != (F = xe(1, 8)) && 2 != F && 3 != F && 4 != F && !k || 4 == Be || (Ce = 4),
                        5 != F && 6 != F || 10 == Ne || k || (Ce = 10),
                        7 != F || Ze || k || (Ce = 18),
                        8 != F || $e || et || 7 == Be || 8 == Be || k || (Ce = 7)) : 18 == Ce ? Ce = 9 : 9 == Ce ? (Ze = !0,
                        1 == (F = xe(1, 2)) && (Ce = 5),
                        2 == F && (Ce = 6),
                        6 == Ne && (Ne = 10)) : 10 == Ce ? (1 != (F = xe(1, 7)) && 2 != F && 3 != F && 4 != F && 5 != F || (Ce = 6),
                        6 != F && 7 != F || 11 == Be || 21 == Be || 11 == Ne || (Ce = 21)) : 7 == Ce ? Ce = 19 : 19 == Ce && (et = !0,
                        1 == (F = xe(1, 2)) && (Ce = 5),
                        2 == F && (Ce = 6),
                        6 == Ne && (Ne = 10))
                }
                n - ot > 4933 && 0 == xe(0, 5) && (ot = n,
                xe(3, 20) < qe) && (k = 0 == Pe && tt > (1 == it ? 3 : 2) || 1 == xe(0, 2),
                17 == Be && 11 != Ne ? (Be = 11,
                21 == Ce && (Ce = 11)) : 11 == Be || 21 == Be ? (1 != (F = xe(1, 7)) && 2 != F || (Be = 14,
                14 == Ne && (Ne = 13)),
                (3 == F || 4 == F || k || n - He >= 5e3 * (25 - qe)) && (Be = 13,
                13 == Ne && (Ne = 14)),
                5 == F && (Be = 15),
                6 == F && (Be = 26),
                7 == F && (Be = 3)) : 14 == Be ? ((1 == (F = xe(1, 5)) || 3 == F || k || n - He >= 5e3 * (25 - qe)) && (Be = 13,
                13 == Ne && (Ne = 14)),
                2 != F && 4 != F || (Be = 15),
                5 == F && 11 != Ne && 11 != Ce && 21 != Ce && (Be = 21)) : 13 == Be ? (F = xe(1, 8),
                (0 == He || n - He >= 4e3 * (25 - qe) || 1 == F || 3 == F || 7 == F || 8 == F || k) && (Be = 16),
                2 != F && 4 != F || (Be = 14,
                14 == Ne && (Ne = 13)),
                5 == F && 11 != Ne && 11 != Ce && 21 != Ce && (Be = 21),
                6 == F && 2 != Ne && (Be = 3)) : 16 == Be ? Be = 22 : 22 == Be ? Be = 23 : 23 == Be ? Ue || Gt ? (He = n,
                Be = 13) : Be = 24 : 15 == Be ? ((1 == (F = xe(1, 3)) || k || n - He >= 7e3 * (25 - qe)) && (Be = 14,
                14 == Ne && (Ne = 13)),
                2 == F && 11 != Ne && 11 != Ce && 21 != Ce && (Be = 21),
                3 == F && (Be = 26)) : 26 == Be ? (1 != (F = xe(1, 3)) && 2 != F || (Be = 15),
                3 == F && (Be = 20)) : 20 == Be ? Be = 26 : 3 == Be ? ((2 == (F = xe(1, 2)) || k) && (Be = 13,
                13 == Ne && (Ne = 14)),
                1 == F && 4 != Ce && (Be = 4)) : 4 == Be ? (1 != (F = xe(1, 2)) && !k || 2 == Ne || (Be = 3),
                2 != F || $e || et || 7 == Ce || 19 == Ce || (Be = 7)) : 7 == Be ? Be = 8 : 8 == Be && 4 != Ce && ($e = !0,
                Be = 4)),
                n - st > 4926 && 0 == xe(0, 5) && (st = n,
                xe(3, 20) < We) && (k = 0 == Ve && tt > (1 == it ? 3 : 2) || 1 == xe(0, 2),
                17 == Ne && 11 != Ce && 11 != Be && 21 != Ce && 21 != Be ? (Ne = 11,
                3 == it && 0 == It && (It = 3)) : 11 == Ne ? (1 != (F = xe(1, 6)) && 2 != F && 3 != F && !k || 3 == Be || (Ne = 2),
                4 != F && 5 != F || 10 == Ce || (Ne = 10),
                6 == F && (14 != Be ? Ne = 14 : 13 != Be && 16 != Be && (Ne = 13))) : 10 == Ne && 6 != Ce && 5 != Ce ? Ne = 6 : 2 == Ne ? ((1 == (F = xe(1, 4)) || 2 == F || k) && (Ne = 1),
                3 == F && (Ne = 4),
                4 == F && 13 != Be && 16 != Be && (Ne = 13)) : 4 == Ne && 5 != Ce && 6 != Ce ? Ne = !k && 1 != xe(1, 3) || 3 == Be ? 6 : 2 : 6 == Ne ? ((1 == (F = xe(1, 3)) || 2 == F || k || n - Ve >= 9e3 * (25 - We)) && (Ne = 4),
                3 == F && 10 != Ce && (Ne = 10)) : 10 == Ne ? (1 != (F = xe(1, 3)) && 2 != F || 5 == Ce || 6 == Ce || (Ne = 6),
                3 == F && 11 != Ce && 11 != Be && 21 != Ce && 21 != Be && (Ne = 11)) : 13 == Ne ? ((2 == (F = xe(1, 3)) || 3 == F || k || n - Ve >= 6e3 * (25 - We)) && 3 != Oe && (Ne = 2),
                1 == F && 14 != Be && (Ne = 14)) : 14 == Ne ? ((2 == (F = xe(1, 3)) || 3 == F || k || n - Ve >= 6e3 * (25 - We)) && 11 != Ce && 11 != Be && 21 != Ce && 21 != Be && (Ne = 11),
                1 == F && 13 != Be && (Ne = 13)) : 1 == Ne ? ((1 == (F = xe(1, 2)) || 0 == Ve || n - Ve >= 7e3 * (25 - We)) && (Ne = 0),
                2 == F && (Ne = 3 != Be ? 2 : 0)) : 0 == Ne && 1 == xe(0, 7) && (Ne = 0 == xe(0, 1) && 3 != Be ? 2 : 1,
                Ve = n)),
                n - pt > 4757 && 0 == xe(0, 5) && (pt = n,
                xe(3, 20) < Ke) && (-1 == Oe ? (Oe = 6,
                6 == it && 0 == It && (It = 4)) : 0 == Oe ? De || Gt ? n - ht > 15e3 && (1 == (F = xe(1, 2)) && (Oe = 2),
                2 == F && (Oe = 1),
                ze = n) : Oe = 25 : 1 == Oe || 2 == Oe ? n - ze >= 3e3 * (25 - Ke) || 0 == xe(0, 3) ? (1 == (F = xe(1, 2)) && (Oe = 0),
                2 == F && (Oe = 13)) : Oe = 3 : 3 == Oe ? Oe = n - ze >= 4e3 * (25 - Ke) || 0 == xe(0, 3) ? 2 : 4 : 4 == Oe ? Oe = n - ze >= 4e3 * (25 - Ke) || 0 == xe(0, 1) ? 2 : 7 : 6 == Oe ? (1 != (F = xe(1, 11)) && 7 != F && 9 != F || (Oe = 1),
                2 != F && 8 != F && 10 != F || (Oe = 2),
                3 != F && 11 != F || (Oe = 7),
                4 == F && (Oe = 15),
                5 == F && (Oe = 14),
                6 == F && (Oe = 13)) : 7 == Oe ? (1 == (F = xe(1, 2)) && (Oe = 4),
                2 == F && (Oe = 6)) : 15 == Oe ? Oe = 14 : 14 == Oe ? Oe = 13 : 13 == Oe ? Oe = n - ze >= 3500 * (25 - Ke) || 0 == xe(0, 3) ? 22 : 2 : 22 == Oe ? Oe = 23 : 23 == Oe && (Ue || Gt ? n - ht > 15e3 && (Oe = 13,
                ze = n) : Oe = 25)),
                n - ct > 6579 && 0 == xe(0, 20) && (ct = n,
                xe(3, 20) < Je && Ge < 4 && (n - lt > 2e3 + 200 * (20 - Je) ? (Ge += 1,
                gt = n,
                ke && 4 == Ge && 0 == Se && (aa[0] = n + 200,
                j(J.laxdudecart, K.main),
                Ge = 5,
                gt = n,
                je = Te,
                dt = !0),
                1 == Ge && 0 == xe(0, 2) && j(J.toilet, K.main),
                2 == Ge && (j(J.deee, K.main),
                2 == it && 0 == It && (It = 2)),
                na(3),
                DEBUG && console.log("lax + 1 > " + Ge)) : ft > 2e4 + 1e3 * (25 - Je) && (Ge = 4,
                gt = n,
                na(3),
                ke && 0 == Se && (aa[0] = n + 200,
                j(J.laxdudecart, K.main),
                ...
                var I = [];
                for (Ge != U && I.push(3),
                (!ke || 1 != Se && 2 != Se) && n - lt > xe(1e3, 1e4) && (ft = 0),
                !ke || 1 != Se && 2 != Se || (lt = n),
                4 == Ge && n - gt > 2e4 && (Ge = 5,
                ...
                na(Ce),
                na(p),
                DEBUG && console.log("longarms: " + p + " > " + Ce)),
                Be != w && (I.push(Be),
                n,
                na(Be),
                na(w),
                DEBUG && console.log("wierdclimber: " + w + " > " + Be)),
                Ne != D && (I.push(Ne),
                wt = n,
                na(Ne),
                na(D),
                DEBUG && console.log("charles: " + D + " > " + Ne)),
                Oe != X && (I.push(Oe),
                ht = n,
                aa[Oe] = Nt ? n + xe(100, 200) : n + xe(3e3, 4e3),
                -1 != X && (aa[X] = Nt ? n + xe(1e3, 2e3) : n + xe(15e3, 3e4)),
                DEBUG && console.log("winston: " + X + " > " + Oe)),
                r = 0; r < I.length; r++) {
                    const e = I[r];
                    setTimeout(function() {
                ...
                if (I.length > 0 && n - Ut > xe(75e3, 2e5) && (Ut = n,
                j(J.loud[xe(0, 4)], K.half)),
                n - Ut > xe(15e4, 3e5) && (Ut = n,
                2 == Ne || 0 != xe(0, 2) ? j(J.loud[xe(3, 4)], K.main) : j(J.loud[xe(0, 2)], K.half)),
                ((0 == Ce || 0 == Oe) && De || (23 == Be || 23 == Oe) && Ue) && n - Ft > 5e3 && 0 == xe(0, 60) && (Ft = n,
                ...
                25 == Ne && n - wt > xe(2e4, 35e3) - 600 * We && (Ne = 24,
                wt = n)
            }
            if (ke && 0 == Tt) {
                var z = !1;
                if (1 != Se && 2 != Se || (ft += n - ut),
                !De && !Gt && 0 == Ne && n - wt > xe(15e3, 3e4) - 600 * We && (Ne = 25,
                wt = n,
                na(0),
                DEBUG && console.log("charles is in")),
                oa(K.office, .03),
                oa(K.sstatic, Math.max(.07 * (Wt - .17), 0)),
                T)
                    for (r = 0; r < 18; r++) {
                        var Y = 760 + ea[r][0]
                          , q = 325 + ea[r][1];
                        be(Y, q, Y + 37, q + 25) && Se != r && (j(J.camswitch, K.main),
                        je = Te,
                        Se = r,
                        z = !0)
                    }
                if ((z || m) && (4 == Ge && 0 == Se ? (j(J.laxdudecart, K.main),
                Ge = 5,
                gt = n,
                dt = !0) : dt = !1),
                n - aa[Se] > 0) {
                    ...
                    17 == Se) {
                        ...
                        var Q = 360 + (te = 640);
                        (ae = Math.abs((3 * Te + 5464) % (2 * Q) - Q) - 180) < 0 && (ae = 0),
                        ae > te && (ae = te),
                        Ee.push(),
                        Ee.translate([-ae, 0]),
                        Ee.scale([1920, 720]),
                        ...
                        Q = 360 + (te = 1280),
                        (ae = Math.abs((3 * Te + 43234) % (2 * Q) - Q) - 180) < 0 && (ae = 0),
                        ae > te && (ae = te),
                        fe.bind(),
                        pe(.4, 1),
                        Ee.push(),
                        ...
                        Ee.scale([1210, 720]),
                        18 == Ce ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].r.l18),
                        Z(fe)) : 9 == Ce ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].r.lt),
                        Z(fe)) : Ze && (a.bindTexture(a.TEXTURE_2D, W.cams[16].r.lf),
                        Z(fe)),
                        Ee.pop(),
                        Ee.push(),
                        Ee.translate([-ae, 0]),
                        Ee.scale([1250, 720]),
                        7 == Ce ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.l7),
                        Z(fe)) : 19 == Ce ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.lt),
                        Z(fe)) : et ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.wf),
                        Z(fe)) : 7 == Be ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.w7),
                        Z(fe)) : 8 == Be ? (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.lt),
                        Z(fe)) : $e && (a.bindTexture(a.TEXTURE_2D, W.cams[16].l.wf),
                        Z(fe)),
                        Ee.pop(),
                        Ee.push(),
                ...
                Z(ce),
                Ee.pop(),
                Math.floor(Te / 20) % 2 == 0 && (Ee.push(),
                Ee.translate([578, 30]),
                Ee.scale([103, 28]),
                a.bindTexture(a.TEXTURE_2D, W.office.rec),
                Z(ce),
                Ee.pop()),
                Qe && (be(900, 0, 1280, 720) || be(0, 600, 1280, 720)) && (Qe = !1),
                Qe || be(730, 0, 1280, 720) || be(0, 500, 1280, 720) || (Qe = !0),
                Qe) {
                    for (Ee.push(),
                    ...
                    r = 0; r < 18; r++) {
                        ...
                        Ee.translate(ne),
                        Ee.scale([15, 10]),
                        r == Se && Math.floor(Te / 15) % 2 == 0 ? ee([.551 / 1.5, .68 / 1.5, 0, 1]) : ee([.258 / 1.5, .258 / 1.5, .258 / 1.5, 1]),
                        Ee.pop()
                    }
                    Ee.push(),
                    Ee.scale([200, 150]),
                ...
                oa(K.camglitch, 0),
                Rt && oa(K.ambience, 0),
                be(0, 0, 200, 720) && (ye -= 10),
                be(0, 0, 400, 720) && (ye -= 5),
                be(880, 0, 1280, 720) && (ye += 5),
                be(1080, 0, 1280, 720) && (ye += 10),
                T && !Rt && 0 == Tt && (be(64, 492, 118, 566) ? 24 == Ce || 24 == Oe || 25 == Oe ? j(J.doorerr, K.main) : (j(J.door, K.main),
                De = !De,
                Ae = Te) : be(1176, 486, 1217, 572) && (24 == Be || 24 == Oe || 25 == Oe ? j(J.doorerr, K.main) : (j(J.door, K.main),
                Ue = !Ue,
                Xe = Te)),
                !be(61, 320, 90, 370) || 24 != Ce && 24 != Oe && 25 != Oe || j(J.doorerr, K.main),
                !be(1205, 318, 1231, 369) || 24 != Be && 24 != Oe && 25 != Oe || j(J.doorerr, K.main)),
                h && !Rt && 0 == Tt ? (be(61, 320, 90, 370) && 24 != Ce && 24 != Oe && 25 != Oe ? 0 == bt && (0 == Oe ? (De || j(J.winston, K.main),
                bt = W.office.llights) : 0 == Ce ? (De || j(J.longarms, K.main),
                bt = W.office.llightl) : bt = W.office.llight) : bt = 0,
                be(1205, 318, 1231, 369) && 24 != Be && 24 != Oe && 25 != Oe ? 0 == xt && (23 == Oe ? (Ue || j(J.winston, K.main),
                xt = W.office.rlights) : 23 == Be ? (Ue || j(J.weirdclimber, K.main),
                xt = W.office.rlightw) : xt = W.office.rlight) : xt = 0) : (xt = 0,
                bt = 0),
                4 == Tt && (ye -= 50),
                ye < 0 && (ye = 0),
                ye > 384 && (ye = 384);
                ...
                0 == Tt)
                    ...
                    Z(fe),
                    Ee.pop()),
                    Te - Ae < 8 ? (De ? a.bindTexture(a.TEXTURE_2D, W.office.ldoor[Te - Ae]) : a.bindTexture(a.TEXTURE_2D, W.office.ldoor[7 - (Te - Ae)]),
                    Ee.push(),
                    Ee.translate([-ye, 0]),
                    Ee.scale([375, 720]),
                    Z(fe),
                    Ee.pop()) : De ? (0 != bt ? (re = 1,
                    a.bindTexture(a.TEXTURE_2D, W.office.ldoor.l)) : a.bindTexture(a.TEXTURE_2D, W.office.ldoor.d),
                    Ee.push(),
                    Ee.translate([-ye, 0]),
                    Ee.scale([375, 720]),
                    Z(fe),
                    ...
                    Z(fe),
                    Ee.pop()),
                    Te - Xe < 8 ? (Ue ? a.bindTexture(a.TEXTURE_2D, W.office.rdoor[Te - Xe]) : a.bindTexture(a.TEXTURE_2D, W.office.rdoor[7 - (Te - Xe)]),
                    Ee.push(),
                    Ee.translate([1664 - ye - 375, 0]),
                    Ee.scale([375, 720]),
                    Z(fe),
                    Ee.pop()) : Ue ? (0 != xt ? (re = 1,
                    a.bindTexture(a.TEXTURE_2D, W.office.rdoor.l)) : a.bindTexture(a.TEXTURE_2D, W.office.rdoor.d),
                    Ee.push(),
                    Ee.translate([1664 - ye - 375, 0]),
                    Ee.scale([375, 720]),
                    Z(fe),
                    ...
                    if (1 == Tt)
                        ...
                        Ee.pop(),
                        se >= 19 && (oe = !0),
                        se < 17 && (Ue && (a.bindTexture(a.TEXTURE_2D, W.office.rdoor.d),
                        Ee.push(),
                        Ee.translate([1664 - ye - 375, 0]),
                        Ee.scale([375, 720]),
                        Z(fe),
                        Ee.pop()),
                        De && (a.bindTexture(a.TEXTURE_2D, W.office.ldoor.d),
                        Ee.push(),
                        Ee.translate([-ye, 0]),
                        Ee.scale([375, 720]),
                        Z(fe),
                        ...
                        Ee.pop(),
                        se >= 17 && (oe = !0),
                        Ue && (a.bindTexture(a.TEXTURE_2D, W.office.rdoor.d),
                        Ee.push(),
                        Ee.translate([1664 - ye - 375, 0]),
                        Ee.scale([375, 720]),
                        Z(fe),
                        ...
                        var ue = 50 * me;
                        ue > 2e4 && (ue = 2e4),
                        1 == kt && n - nt > 39e3 - ue && (kt = 2,
                        nt = n,
                        Xt = ye,
                        L()),
                        2 == kt && n - nt > xe(300, 1e3) && (kt = 3),
                        3 == kt && n - nt > 2e4 - ue - 10 * me && (Tt = 6,
                        Et = Te,
                        L(),
                        S());
                        var de = !(2 == kt && 0 != xe(0, 2));
                        kt < 3 && de && (a.bindTexture(a.TEXTURE_2D, W.office.dark1),
                        Ee.push(),
                        Ee.translate([-ye, 0]),
                        Ee.scale([1664, 720]),
                        Z(fe),
                        Ee.pop()),
                        oa(K.office, 2 == kt && de ? .05 : 0),
                        1 == kt && (Te / 2 ^ 3566) % 3 != 0 && (pe(.3, 150 / 720),
                ...
                oa(K.lights, re),
                E && n - _e < 1e4 && (i.font = "20px VT323",
                i.fillStyle = "#FFFFFF",
                G("press F to enter fullscreen and hide this message", 50));
                var he = 0 == Tt ? Te - Ie : 2 * (Te - Ie) + 3;
                he < 10 ? (Fe ? a.bindTexture(a.TEXTURE_2D, W.office.cam_anim[he]) : a.bindTexture(a.TEXTURE_2D, W.office.cam_anim[9 - he]),
                Ee.push(),
                Ee.scale([1280, 720]),
                Z(ce),
                Ee.pop()) : Rt || 0 != Tt || (Le || (a.bindTexture(a.TEXTURE_2D, W.office.camzone),
                Ee.push(),
                Ee.translate([320, 650]),
                Ee.scale([600, 60]),
                Z(ce),
                Ee.pop()),
                !St && n - Mt > 6e3 && n - Mt < 15e3 && (1 == it ? (a.bindTexture(a.TEXTURE_2D, W.skipcall),
                T && be(10, 10, 110, 45) && (tt = 2,
                Ye += 1,
                qe += 1,
                Ct = n + 1e3,
                vt -= 200,
                ...
                St = !0)) : (a.bindTexture(a.TEXTURE_2D, W.mutecall),
                T && be(10, 10, 110, 45) && (oa(K.call, 0),
                St = !0)),
                Ee.push(),
                Ee.translate([10, 10]),
                Ee.scale([100, 35]),
                Z(ce),
                Ee.pop()),
                0 != It && 69 != It && (Lt ? (a.bindTexture(a.TEXTURE_2D, 1 == It ? W.sticky1 : 2 == It ? W.sticky2 : 3 == It ? W.sticky3 : W.sticky4),
                Ee.push(),
                Ee.translate([490, 200]),
                Ee.scale([300, 300]),
                Z(ce),
                Ee.pop(),
                (_[27] || T && !be(490, 200, 790, 500) && !be(1070, 585, 1280, 720)) && (Lt = !1,
                It = 69)) : (a.bindTexture(a.TEXTURE_2D, W.foundsticky),
                C(),
                Ee.push(),
                ...
                Ee.pop(),
                B(),
                T && be(1070, 585, 1280, 720) && (j(J.stickyopen, K.main),
                Lt = !0))),
                n - Ct < 0 && Kt()),
                la += .1 * Math.random() - .06,
                Math.random() < .001 && (la += .7 * Math.random() - .35),
                la < 0 && (la = 0),
                la > .3 && (la -= .2),
                la > 1 && (la = 1),
                Ee.push(),
            ...
            De && (qt += 1),
            ke && (qt += 1),
            (2 == it && n - _t > 6e3 || 3 == it && n - _t > 5e3 || 4 == it && n - _t > 4e3 || it >= 5 && n - _t > 3e3 && !Bt) && (_t = n,
            vt -= 1),
            n - yt >= 1e3 && !Bt && (yt = n,
            (vt -= qt) <= 5 && !Rt && (De && (De = !1,
            Ae = Te,
            ...
            oa(K.ambience, 0),
            nt = n,
            j(J.powerloss, K.main)),
            !Lt && n - Ct > 100)) {
                var ia = Math.floor(vt / 10);
                i.font = "40px font",
                i.fillStyle = "#FFFFFF",
                O(0 == tt ? "12 AM" : tt + " AM", 40, 65),
                i.font = "20px font",
                O("Night " + it, 40, 95),
            ...
            n - nt < 1e4 ? Kt() : n - nt < 15e3 ? (a.bindTexture(a.TEXTURE_2D, W.death),
            Ee.push(),
            Ee.scale([1280, 720]),
            Z(ce),
            Ee.pop()) : (ge = 1,
            ...
            nt = n,
            ge = 6,
            j(J.sticknya, K.main)) : 6 == it ? (ha(!0),
            nt = n,
            ge = 6,
            j(J.sticknya, K.main)) : 7 == it ? (20 != We || 20 != Ye || 20 != qe || 20 != Je || 20 != Ke || Bt || Nt || Gt || Ta(!0),
            nt = n,
            ge = 6,
            j(J.sticknya, K.main)) : 8 == it ? (ge = 1,
            zt()) : (wa(it + 1),
            Re = it + 1,
            j(J.camswitch, K.main),
            fa = Te,
            ...
            5 == it && a.bindTexture(a.TEXTURE_2D, W.check1),
            6 == it && a.bindTexture(a.TEXTURE_2D, W.check2),
            7 == it && a.bindTexture(a.TEXTURE_2D, W.check3),
            Ee.push(),
            Ee.scale([1280, 720]),
            Z(ce),
            Ee.pop(),
            ...
            if (a.bindTexture(a.TEXTURE_2D, W.customnight),
            Ee.push(),
            Ee.scale([1280, 720]),
            Z(ce),
            Ee.pop(),
            ...
            T) {
                var sa = !0;
                be(48, 419, 97, 483) ? Ht.longarms > 0 && (Ht.longarms -= 1) : be(204, 419, 253, 483) ? Ht.longarms < 20 && (Ht.longarms += 1) : be(297, 419, 346, 483) ? Ht.wierdclimber > 0 && (Ht.wierdclimber -= 1) : be(453, 419, 502, 483) ? Ht.wierdclimber < 20 && (Ht.wierdclimber += 1) : be(549, 419, 598, 483) ? Ht.laxdude > 0 && (Ht.laxdude -= 1) : be(705, 419, 754, 483) ? Ht.laxdude < 20 && (Ht.laxdude += 1) : be(797, 419, 846, 483) ? Ht.charles > 0 && (Ht.charles -= 1) : be(953, 419, 1002, 483) ? Ht.charles < 20 && (Ht.charles += 1) : be(1042, 419, 1091, 483) ? Ht.winston > 0 && (Ht.winston -= 1) : be(1198, 419, 1247, 483) ? Ht.winston < 20 && (Ht.winston += 1) : be(702, 517, 755, 542) ? Ht.infinitepower = !Ht.infinitepower : be(702, 550, 755, 575) ? Ht.reducedstatic = !Ht.reducedstatic : be(702, 583, 755, 608) ? Ht.noaggression = !Ht.noaggression : be(360, 634, 409, 698) ? ((Ot -= 1) < 0 && (Ot = Pt.length - 1),
                Ht = JSON.parse(JSON.stringify(Pt[Ot]))) : be(1199, 634, 1248, 698) ? ((Ot += 1) > Pt.length - 1 && (Ot = 0),
                Ht = JSON.parse(JSON.stringify(Pt[Ot]))) : be(867, 517, 1249, 620) ? (sa = !1,
                Re = 7,
                L(),
                j(J.camswitch, K.main),
                fa = Te,
                ge = 2) : be(30, 30, 80, 80) ? (sa = !1,
                ge = 1) : sa = !1,
                sa && j(J.doorerr, K.main)
            }
            _[27] && (ge = 1),
            i.fillStyle = "#FFFFFF",
            i.font = "60px font",
            ...
            i.font = "30px font",
            Ht.infinitepower && i.fillText("X", 720, 543),
            Ht.reducedstatic && i.fillText("X", 720, 575),
            Ht.noaggression && i.fillText("X", 720, 608)
        }
        for (_[70] && A(),
        h = !1,
        T = !1,
        r = 0; r < 255; r++)
            _[r] = !1,
            y[r] = !1;
        for (; (t = a.getError()) != a.NO_ERROR; )
            t == a.INVALID_ENUM ? console.log("GL ERROR: INVALID_ENUM") : t == a.INVALID_VALUE ? console.log("GL ERROR: INVALID_VALUE") : t == a.INVALID_OPERATION ? console.log("GL ERROR: INVALID_OPERATION") : t == a.INVALID_FRAMEBUFFER_OPERATION ? console.log("GL ERROR: INVALID_FRAMEBUFFER_OPERATION") : t == a.OUT_OF_MEMORY ? console.log("GL ERROR: OUT_OF_MEMORY") : t == a.CONTEXT_LOST_WEBGL && console.log("GL ERROR: CONTEXT_LOST_WEBGL")
    }, 1e3 / 30)
});
